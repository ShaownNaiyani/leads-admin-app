...
class LeadsData(models.Model):
    ...
    asin = models.CharField(max_length=255, unique=True, primary_key=True,
                            blank=False, null=False, verbose_name="ASIN")
    ...
    estimated_sales_rank = models.PositiveIntegerField(
        default=0, editable=False,  null=True, verbose_name="EstimatedSalesRank")
    sales_rank_30_days = models.PositiveIntegerField(
        default=0, editable=False,  null=True, verbose_name="SalesRank30Days")
    sales_rank_90_days = models.PositiveIntegerField(
        default=0, editable=False,  null=True, verbose_name="SalesRank90Days")
    estimated_monthly_sales = models.PositiveIntegerField(
        default=0, editable=False,  null=True, verbose_name="EstimatedMonthlySales")
    ...
    number_of_sellers_on_listing = models.PositiveIntegerField(
        default=0,  null=True, editable=False, verbose_name="NumberOfSellersOnListing")
    number_of_reviews = models.PositiveIntegerField(
        default=0,  null=True, editable=False, verbose_name="NumberOfReviews")
